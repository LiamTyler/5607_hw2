...
class Camera {
    public:
        ...
        // setters
        void setPos(vec3 v) { camera_pos_ = v; }
        void setDir(vec3 v) { camera_dir_ = v; }
        void setUp(vec3 v) { camera_up_ = v; }
        ...
        // getters
        vec3 getPos() { return camera_pos_; }
        vec3 getDir() { return camera_dir_; }
        vec3 getUp() { return camera_up_; }
